...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 1687.0, "minX": 0.0, "maxY": 1687.0, "series": [{"data": [[0.0, 1687.0]], "isOverall": false, "label": "POST /api/admin/coupons", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var syntheticResponseTimeDistributionInfos = {
        data: {"result": {"minY": 1687.0, "minX": 0.0, "ticks": [[0, "Requests having \nresponse time <= 500ms"], [1, "Requests having \nresponse time > 500ms and <= 1,500ms"], [2, "Requests having \nresponse time > 1,500ms"], [3, "Requests in error"]], "maxY": 1687.0, "series": [{"data": [[0.0, 1687.0]], "color": "#9ACD32", "isOverall": false, "label": "Requests having \nresponse time <= 500ms", "isController": false}, {"data": [], "color": "yellow", "isOverall": false, "label": "Requests having \nresponse time > 500ms and <= 1,500ms", "isController": false}, {"data": [], "color": "orange", "isOverall": false, "label": "Requests having \nresponse time > 1,500ms", "isController": false}, {"data": [], "color": "#FF6347", "isOverall": false, "label": "Requests in error", "isController": false}], "supportsControllersDiscrimination": false, "maxX": 4.9E-324, "title": "Synthetic Response Times Distribution"}},
        getOptions: function() {
            return {
                legend: {
                    noColumns: 2,
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 8.634374999999997, "minX": 1.78683264E12, "maxY": 25.26406926406928, "series": [{"data": [[1.78683264E12, 8.634374999999997], [1.7868327E12, 25.26406926406928], [1.78683276E12, 11.971698113207562]], "isOverall": false, "label": "STRESS - Create Coupons - 5 to 10 to 20 to 30 to 5 VUs", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78683276E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 4.0, "minX": 1.0, "maxY": 8.153846153846155, "series": [{"data": [[2.0, 8.0], [3.0, 5.0], [4.0, 7.0], [5.0, 6.720779220779218], [6.0, 6.0], [7.0, 6.333333333333333], [8.0, 5.80952380952381], [9.0, 6.055555555555556], [10.0, 6.363636363636362], [11.0, 6.3], [12.0, 6.571428571428571], [13.0, 6.000000000000001], [14.0, 6.5625], [15.0, 8.153846153846155], [16.0, 6.823529411764706], [1.0, 4.0], [17.0, 6.75], [18.0, 6.222222222222221], [19.0, 6.588235294117648], [20.0, 6.234636871508379], [21.0, 6.7407407407407405], [22.0, 5.482758620689655], [23.0, 6.076923076923077], [24.0, 5.689655172413793], [25.0, 5.938775510204081], [26.0, 5.592592592592593], [27.0, 5.275862068965519], [28.0, 5.36734693877551], [29.0, 5.523809523809525], [30.0, 5.509164969450104]], "isOverall": false, "label": "POST /api/admin/coupons", "isController": false}, {"data": [[20.439241256668613, 6.033787788974518]], "isOverall": false, "label": "POST /api/admin/coupons-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 30.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 1077.6666666666667, "minX": 1.78683264E12, "maxY": 9903.683333333332, "series": [{"data": [[1.78683264E12, 1619.7], [1.7868327E12, 5860.016666666666], [1.78683276E12, 1077.6666666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78683264E12, 2740.266666666667], [1.7868327E12, 9903.683333333332], [1.78683276E12, 1818.5166666666667]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78683276E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 5.684848484848484, "minX": 1.78683264E12, "maxY": 7.0896226415094326, "series": [{"data": [[1.78683264E12, 6.593749999999999], [1.7868327E12, 5.684848484848484], [1.78683276E12, 7.0896226415094326]], "isOverall": false, "label": "POST /api/admin/coupons", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78683276E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 5.665800865800868, "minX": 1.78683264E12, "maxY": 7.0707547169811304, "series": [{"data": [[1.78683264E12, 6.540624999999999], [1.7868327E12, 5.665800865800868], [1.78683276E12, 7.0707547169811304]], "isOverall": false, "label": "POST /api/admin/coupons", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78683276E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.6545454545454541, "minX": 1.78683264E12, "maxY": 1.0437499999999993, "series": [{"data": [[1.78683264E12, 1.0437499999999993], [1.7868327E12, 0.6545454545454541], [1.78683276E12, 0.7028301886792452]], "isOverall": false, "label": "POST /api/admin/coupons", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78683276E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 4.0, "minX": 1.78683264E12, "maxY": 33.0, "series": [{"data": [[1.78683264E12, 33.0], [1.7868327E12, 18.0], [1.78683276E12, 24.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.78683264E12, 8.0], [1.7868327E12, 7.0], [1.78683276E12, 9.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.78683264E12, 13.79000000000002], [1.7868327E12, 10.0], [1.78683276E12, 23.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.78683264E12, 8.0], [1.7868327E12, 8.0], [1.78683276E12, 20.349999999999994]], "isOverall": false, "label": "95th percentile", "isController": false}, {"data": [[1.78683264E12, 4.0], [1.7868327E12, 4.0], [1.78683276E12, 4.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.78683264E12, 6.0], [1.7868327E12, 6.0], [1.78683276E12, 6.0]], "isOverall": false, "label": "Median", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78683276E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 5.0, "minX": 1.0, "maxY": 7.0, "series": [{"data": [[2.0, 6.5], [3.0, 6.0], [4.0, 6.0], [5.0, 6.0], [6.0, 6.0], [7.0, 6.0], [8.0, 6.0], [9.0, 6.0], [10.0, 6.0], [11.0, 6.0], [12.0, 6.0], [13.0, 6.0], [14.0, 6.0], [15.0, 6.0], [1.0, 7.0], [16.0, 6.0], [17.0, 6.0], [18.0, 6.0], [19.0, 6.0], [20.0, 6.0], [21.0, 6.0], [22.0, 5.0], [23.0, 5.0], [24.0, 5.0], [25.0, 5.0], [26.0, 6.0], [27.0, 5.0], [28.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 28.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 5.0, "minX": 1.0, "maxY": 7.0, "series": [{"data": [[2.0, 6.5], [3.0, 6.0], [4.0, 6.0], [5.0, 6.0], [6.0, 6.0], [7.0, 6.0], [8.0, 6.0], [9.0, 6.0], [10.0, 6.0], [11.0, 6.0], [12.0, 6.0], [13.0, 6.0], [14.0, 6.0], [15.0, 6.0], [1.0, 7.0], [16.0, 6.0], [17.0, 5.0], [18.0, 6.0], [19.0, 6.0], [20.0, 6.0], [21.0, 6.0], [22.0, 5.0], [23.0, 5.0], [24.0, 5.0], [25.0, 5.0], [26.0, 6.0], [27.0, 5.0], [28.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 28.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 3.533333333333333, "minX": 1.78683264E12, "maxY": 19.25, "series": [{"data": [[1.78683264E12, 5.333333333333333], [1.7868327E12, 19.25], [1.78683276E12, 3.533333333333333]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78683276E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 3.533333333333333, "minX": 1.78683264E12, "maxY": 19.25, "series": [{"data": [[1.78683264E12, 5.333333333333333], [1.7868327E12, 19.25], [1.78683276E12, 3.533333333333333]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78683276E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 3.533333333333333, "minX": 1.78683264E12, "maxY": 19.25, "series": [{"data": [[1.78683264E12, 5.333333333333333], [1.7868327E12, 19.25], [1.78683276E12, 3.533333333333333]], "isOverall": false, "label": "POST /api/admin/coupons-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78683276E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 3.533333333333333, "minX": 1.78683264E12, "maxY": 19.25, "series": [{"data": [[1.78683264E12, 5.333333333333333], [1.7868327E12, 19.25], [1.78683276E12, 3.533333333333333]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78683276E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
