...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 2123.0, "minX": 0.0, "maxY": 2123.0, "series": [{"data": [[0.0, 2123.0]], "isOverall": false, "label": "GET /api/users/me", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 18.131097560975572, "minX": 1.78682706E12, "maxY": 19.97190517998243, "series": [{"data": [[1.78682712E12, 18.131097560975572], [1.78682706E12, 19.97190517998243]], "isOverall": false, "label": "SPIKE - Users Me - Aggregate 5 to 25 to 5 VUs", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78682712E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.0, "minX": 1.0, "maxY": 3.8749999999999996, "series": [{"data": [[2.0, 3.0], [3.0, 3.0], [4.0, 2.0], [5.0, 3.411646586345383], [6.0, 2.857142857142857], [7.0, 3.3636363636363638], [8.0, 3.25], [9.0, 3.0], [10.0, 3.25], [11.0, 2.5384615384615383], [12.0, 2.6315789473684212], [13.0, 3.0999999999999996], [14.0, 2.45], [15.0, 3.1], [16.0, 3.8749999999999996], [1.0, 2.0], [17.0, 2.8125], [18.0, 2.8461538461538463], [19.0, 2.571428571428571], [20.0, 2.958333333333333], [21.0, 2.666666666666667], [22.0, 3.1599999999999997], [23.0, 2.4666666666666663], [24.0, 2.6999999999999997], [25.0, 2.824943651389934]], "isOverall": false, "label": "GET /api/users/me", "isController": false}, {"data": [[19.118699952896854, 2.9637305699481917]], "isOverall": false, "label": "GET /api/users/me-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 25.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 4690.4, "minX": 1.78682706E12, "maxY": 8580.466666666667, "series": [{"data": [[1.78682712E12, 7412.8], [1.78682706E12, 8580.466666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78682712E12, 4690.4], [1.78682706E12, 5429.233333333334]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78682712E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 2.6758130081300826, "minX": 1.78682706E12, "maxY": 3.2124670763827967, "series": [{"data": [[1.78682712E12, 2.6758130081300826], [1.78682706E12, 3.2124670763827967]], "isOverall": false, "label": "GET /api/users/me", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78682712E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 2.66260162601626, "minX": 1.78682706E12, "maxY": 3.190517998244073, "series": [{"data": [[1.78682712E12, 2.66260162601626], [1.78682706E12, 3.190517998244073]], "isOverall": false, "label": "GET /api/users/me", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78682712E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.7378048780487808, "minX": 1.78682706E12, "maxY": 0.880597014925374, "series": [{"data": [[1.78682712E12, 0.7378048780487808], [1.78682706E12, 0.880597014925374]], "isOverall": false, "label": "GET /api/users/me", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78682712E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.78682706E12, "maxY": 55.0, "series": [{"data": [[1.78682712E12, 8.0], [1.78682706E12, 55.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.78682712E12, 3.0], [1.78682706E12, 4.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.78682712E12, 5.0], [1.78682706E12, 6.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.78682712E12, 4.0], [1.78682706E12, 5.0]], "isOverall": false, "label": "95th percentile", "isController": false}, {"data": [[1.78682712E12, 1.0], [1.78682706E12, 1.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.78682712E12, 3.0], [1.78682706E12, 3.0]], "isOverall": false, "label": "Median", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78682712E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 5.0, "maxY": 55.0, "series": [{"data": [[37.0, 3.0], [9.0, 3.0], [38.0, 3.0], [11.0, 3.0], [12.0, 3.0], [50.0, 3.0], [13.0, 3.0], [55.0, 3.0], [14.0, 3.0], [15.0, 3.0], [61.0, 3.0], [63.0, 3.0], [62.0, 3.0], [64.0, 3.0], [67.0, 2.0], [65.0, 3.0], [66.0, 2.0], [68.0, 3.0], [18.0, 3.0], [72.0, 2.0], [5.0, 55.0], [29.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 72.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 5.0, "maxY": 55.0, "series": [{"data": [[37.0, 3.0], [9.0, 3.0], [38.0, 3.0], [11.0, 3.0], [12.0, 3.0], [50.0, 3.0], [13.0, 3.0], [55.0, 3.0], [14.0, 3.0], [15.0, 3.0], [61.0, 3.0], [63.0, 3.0], [62.0, 2.0], [64.0, 3.0], [67.0, 2.0], [65.0, 3.0], [66.0, 2.0], [68.0, 3.0], [18.0, 3.0], [72.0, 2.0], [5.0, 55.0], [29.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 72.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 16.4, "minX": 1.78682706E12, "maxY": 18.983333333333334, "series": [{"data": [[1.78682712E12, 16.4], [1.78682706E12, 18.983333333333334]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78682712E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 16.4, "minX": 1.78682706E12, "maxY": 18.983333333333334, "series": [{"data": [[1.78682712E12, 16.4], [1.78682706E12, 18.983333333333334]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78682712E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 16.4, "minX": 1.78682706E12, "maxY": 18.983333333333334, "series": [{"data": [[1.78682712E12, 16.4], [1.78682706E12, 18.983333333333334]], "isOverall": false, "label": "GET /api/users/me-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78682712E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 16.4, "minX": 1.78682706E12, "maxY": 18.983333333333334, "series": [{"data": [[1.78682712E12, 16.4], [1.78682706E12, 18.983333333333334]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78682712E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
