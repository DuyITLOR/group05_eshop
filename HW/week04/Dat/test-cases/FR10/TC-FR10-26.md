...
|---|---|
| Decision Table & Pairwise | FR10-DTT-26 |

## Detail
| ID | Test Objective | C1: Trạng thái hiện tại | C2: Trạng thái mong muốn | C3: Người thực hiện | Kết quả mong đợi |
|---|---|---|---|---|---|
| FR10-DTT-26 | Admin chuyển đơn hàng từ canceled sang delivered thất bại | canceled | delivered | Admin | R2: Lỗi chuyển đổi |
...
## Actual results
1. Thất bại: Yêu cầu thành công (HTTP status 200 OK).
2. Trạng thái đơn hàng chuyển đổi sai thành `delivered` nhưng hệ thống vẫn cho phép.
