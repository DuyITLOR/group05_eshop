...
|---|---|
| Decision Table & Pairwise | FR10-DTT-27 |

## Detail
| ID | Test Objective | C1: Trạng thái hiện tại | C2: Trạng thái mong muốn | C3: Người thực hiện | Kết quả mong đợi |
|---|---|---|---|---|---|
| FR10-DTT-27 | Admin chuyển đơn hàng từ canceled sang canceled thất bại | canceled | canceled | Admin | R2: Lỗi chuyển đổi |
...
2. Response body: `{"error":"Invalid state transition from canceled to canceled"}`.
3. Trạng thái đơn hàng trong DB giữ nguyên là `canceled`.
