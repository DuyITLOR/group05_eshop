...
## Bug description:
Hệ thống cho phép Admin cập nhật trạng thái đơn hàng đã hủy (`canceled`) sang đã giao hàng (`delivered`). Trái ngược với đặc tả (delivered và canceled là các trạng thái kết thúc, không được phép chuyển đổi trạng thái khác).
