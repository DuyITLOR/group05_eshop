...
## Test case coverage: 
- `GUI-CHK-008` (Kiểm tra hình thức và vị trí hiển thị thông báo lỗi trên form)
...
- Chụp màn hình bug và lưu tại: `./images/GUI-CHK-008.png`
- Nhúng screenshot bug tại đây bằng đường dẫn tương đối: `![Hiển thị lỗi qua Alert trình duyệt](./images/GUI-CHK-008.png)`
