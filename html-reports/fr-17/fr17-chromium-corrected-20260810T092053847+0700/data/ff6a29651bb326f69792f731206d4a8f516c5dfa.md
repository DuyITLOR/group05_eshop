...
- Name: fr-17\fr-17.spec.js >> FR-17 - Coupon management >> FR17-TC-008 discount_value zero is rejected
- Location: tests\fr-17\fr-17.spec.js:141:3
...
Locator:  getByRole('heading', { name: 'Quản lý Mã Giảm Giá', exact: true }).locator('..').locator('table').locator('tbody > tr').filter({ has: getByText('FR17-DISCOUNT-ZERO-TC008-FR17CHROMIUMCORRECTED20260810T0920538470700', { exact: true }) })
Expected: 0
Received: 1
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Quản lý Mã Giảm Giá', exact: true }).locator('..').locator('table').locator('tbody > tr').filter({ has: getByText('FR17-DISCOUNT-ZERO-TC008-FR17CHROMIUMCORRECTED20260810T0920538470700', { exact: true }) })
  ...
  - generic [ref=e15]:
    ...
    - table [ref=e27]:
      ...
      - rowgroup [ref=e37]:
        ...
        - row [ref=e74]:
          - cell "FR17-DISCOUNT-ZERO-TC008-FR17CHROMIUMCORRECTED20260810T0920538470700" [ref=e75]
