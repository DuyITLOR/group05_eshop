...
- Name: fr-05\fr-05.spec.js >> FR-05 - Product listing and search >> FR05-TC-004 - Provide a present non-empty alt attribute
- Location: tests\fr-05\fr-05.spec.js:80:3
...
Locator: getByRole('main').getByRole('heading', { name: 'iPhone 15 Pro Max', exact: true, level: 2 }).locator('..').locator('img')
Expected pattern: /\S/u
Received string:  ""
Timeout: 5000ms

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for getByRole('main').getByRole('heading', { name: 'iPhone 15 Pro Max', exact: true, level: 2 }).locator('..').locator('img')
