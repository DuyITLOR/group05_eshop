...
## Test case coverage: 
- `TC-FR10-10` (Chặn chuyển đổi trạng thái của đơn hàng đã hủy (canceled) — State Transition Testing FR10-STT-10)
...
2. Response body chứa thông báo lỗi về việc chuyển đổi trạng thái không hợp lệ.
